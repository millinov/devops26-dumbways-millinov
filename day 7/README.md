...
![Add User Frontend Server](addusr-frontend.png)

![Add User Backend Server](addusr-backend.png)

![Add User Web Server](addusr-webserver.png)

![Add User Database Server](addusr-database.png)

## The server only can login with SSH-KEY without using password at all

Ini sudah saya buat di config lokal

![SSH Config di Lokal](ssh-config.png)

Jadi jika saya ingin mengakses servernya tinggal menggunakan ```ssh *nama host* ```

## Deploy database MySQL

![MySQL secure installation](secure-sql.png)
...
![Login to MySQL root with password](root-pwd.png)

Saya juga sudah membuat user baru di dalam mysql

![Add User on MySQL](addusr-mysql.png)
...
![Testing Admin 2](test-admin2.png)
...
![MySQL Client Proof](mysql-proof.png)

Kemudian saya konek ke database-server di google cloud

![MySQL Client Remote](mysql-remote.png)

## Deploy Wayshub-Backend

![Wayshub Backend](wayshub-backend.png)
...
![Wayshub Backend 2](wayshub-backend2.png)

## Deploy Wayshub-Frontend Application

![Wayshub Frontend](wayshub-frontend.png)
...
![Wayshub Frontend 2](wayshub-frontend2.png)
